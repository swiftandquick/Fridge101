...
public class Tab2Summary_Freezer_2 extends AppCompatActivity
{
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tab2summary_freezer_2);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {    //on item select listener
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case 0:
                        loadFragment(new FragmentAllItems_F());
                        break;
                    case 1:
                        loadFragment(new FragmentVegetable_F());
                        break;
                    case 2:
                        loadFragment(new FragmentFruit_F());
                        break;
                    case 3:
                        loadFragment(new FragmentGrain_F());
                        break;
                    case 4:
                        loadFragment(new FragmentMeat_F());
                        break;
                    case 5:
                        loadFragment(new FragmentDrink_F());
                        break;
                    case 6:
                        loadFragment(new FragmentOtherFood_F());
                        break;
                    case 7:
                        loadFragment(new FragmentNonFood_F());
                        break;
                }
